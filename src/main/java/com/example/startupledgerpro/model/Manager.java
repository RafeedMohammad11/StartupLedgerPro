...
public class Manager extends User {
    ...
    public Manager(String id, String name, String email, String passwordHash, String phone, boolean isActive) {
        super(id, name, email, passwordHash, UserRole.MANAGER, phone, isActive);
    }
