...
public class Admin extends User {
    ...
    public Admin(String id, String name, String email, String passwordHash, String phone, String joinDate,
            boolean isActive) {
        super(id, name, email, passwordHash, UserRole.ADMIN, phone, joinDate, isActive);
    }
